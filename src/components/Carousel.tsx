...
const CarouselItem = ({
  ...
  return (
    <div id={id} className="carousel-item relative w-full">
      ...
      />
      <div className="cardDetails grid grid-cols-2">
        <div>
        ...
        <div className="grid grid-cols-2">
          <div>
            ...
            <div className="flex">
              ...
              <p>تعداد :</p>
              <p>{productInfo.productAvailability}</p>
            </div>
            <div className="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <p>برند :</p>
            <p>{productInfo.productBrand}</p>
          </div>
          <div>
            <p>زمان بروزرسانی :</p>
            <p>{productInfo.productUpdateTime}</p>
          </div>
        </div>
      </div>
      <div>
