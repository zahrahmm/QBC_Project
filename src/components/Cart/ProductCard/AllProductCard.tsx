...
const AllProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div
      className=" card bg-base-100 shadow-xl w-[672px] h-[200px] rounded-[8px] p-2 flex flex-row flex-1/3 "
    >
    <div><img src={imageUrl} alt={title} className="w-32 h-auto rounded-xl ml-4" /></div>  
      ...
      <div className="flex  flex-cols-2  items-center space-x-15">
          ...
          <button className="btn btn-soft btn-secondary hover:text-white">
